...
const MENU_CONFIG = {
  ...
  dean: [
    ...
    {
      id: "executive-management/competencies",
      icon: ShieldCheck,
      labelKey: "executive_competencies",
    },
    {
      id: "executive-management/comparison",
      icon: GitCompare,
      labelKey: "executive_comparison",
    },
    {
      id: "executive-management/students",
      icon: UserRoundSearch,
      labelKey: "executive_students",
    },
  ],
  lecturer: [
    {
      id: "my-activity-sessions",
      icon: CalendarClock,
      label: "รอบกิจกรรมของฉัน",
    },
  ],
};
...
export function AppLayout({
  ...
  const usesSidebarNavigation =
    role === "officer" || role === "admin" || role === "dean";
  ...
  const primaryRoleLabel =
    primaryRole === "dean" ? t("role_dean") : primaryRole;
  const avatarLabel =
    displayName
      .split(" ")
      .filter(Boolean)
  ...
  return (
    ...
    >
      <>
        ...
        <div
          className={`competency-app ${usesSidebarNavigation ? "competency-app--sidebar" : ""}`}
        >
            ...
            <>
              ...
              {children && (
                <main className={mainContentClass}>
                  <div
                    className={
                      role === "officer" ? "container-officer" : "container"
                    }
                  >
                    {children}
                  </div>
